import closeSvg from '../img/header/Close.svg'
...
function Menu({
    ...
    return (
        <div id="mobile_menu"
            className={`transition-all duration-75 w-full lg:hidden fixed bg-[#00856F] h-screen z-20 top-0 text-center ${modalisopen ? "left-0" : "-left-full"}`}>
            <div className="flex justify-between items-center px-5 py-4 mb-[60px]">
                <a href="index.html" className="text-white text-2xl"> Doctor<span className="text-white font-semibold">Care</span></a>
                <button id="mobile_close" className="cursor-pointer active:opacity-80" onClick={() => setmodalisopen(false)}>
                    <img src={closeSvg} />
                </button>
            </div>
            <ul className="flex flex-col gap-12 text-center mb-12">
                <li><a className="text-[#FFFAF1] font-bold text-2xl leading-[31.25px]" href="#header">Início</a></li>
                <li><a className="text-[#FFFAF1] font-bold text-2xl leading-[31.25px]" href="#Sobre">Sobre</a></li>
                <li><a className="text-[#FFFAF1] font-bold text-2xl leading-[31.25px]" href="#Serviços">Serviços</a></li>
                <li><a className="text-[#FFFAF1] font-bold text-2xl leading-[31.25px]" href="#Depoimentos">Depoimentos</a></li>
            </ul>
            <a className=" header_btn_hover py-3 px-6 bg-transparent rounded-full border border-white bg-white inline-flex text-[#00856F] text-sm leading-5 font-bold uppercase mb-20"
                href="">Agendar consulta</a>
