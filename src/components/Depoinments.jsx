...
import Map from '../img/contact/map.svg'
import Mail from '../img/contact/mail.svg'
import Man from '../img/man-with-phone.png'
function Depoinments() {
    return (
        <div>
            <section id="Depoimentos" className="md:py-40 py-[100px]">
                <div className="max-w-[1180px] px-5 mx-auto md:flex items-center justify-between">
                    <div className="md:mb-0 mb-16 wow animate__animated animate__backInLeft">
                        <h3 className="text-[#212529] font-bold text-[30px] md:text-[40px] leading-10 md:leading-[52.08px] mb-10">Entre em
                            contato <br /> com a gente!</h3>
                        <ul className="flex flex-col gap-4 mb-10">
                            <li><a className="flex items-center gap-2 " href="#"><span><img className="flex" src={Map} /></span>R.
                                Amauri Souza, 346</a></li>
                            <li><a className="flex items-center gap-2 " href="#"><span><img className="flex"
                                src={Mail} /></span>contato@doctorcare.com</a></li>
                        </ul>
                        <button
                            className="btn_hover flex items-center gap-2 rounded-full text-white font-bold text-base leading-5 py-4 px-8 bg-[#00856F] border-[#00856F] border"><span>
                    ...
                    <div className="wow animate__animated animate__backInRight">
                        <img className="max-w-[575px] w-full flex" src={Man} alt="man-with-phone" />
                    </div>
                </div>
            </section>
        </div>
